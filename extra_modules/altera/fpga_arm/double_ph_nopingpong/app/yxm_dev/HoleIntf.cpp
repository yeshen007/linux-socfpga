...
unsigned short CYxmIntf::ReadHole(unsigned int addr, int ph)
{
	void * reg_addr;
	...
	hole_val = reg_val & 0xffff;

	return hole_val;
}

void CYxmIntf::WriteHole(unsigned int addr, unsigned short data, int ph)
{
	void * reg_addr;
