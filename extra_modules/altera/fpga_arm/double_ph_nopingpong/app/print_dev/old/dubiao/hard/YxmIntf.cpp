...
void CYxmIntf::Step3_1()
{
	...
	alt_write_word(reg_addr, 8000000);	
...
void CYxmIntf::PrintRegs()
{
	...
	for (reg_index = 50; reg_index <= 355; reg_index++) {
		...
		fprintf(regs_value_file, "reg %lu -- addr %p -- decvalue %d -- hexvalue 0x%08x\n", 
